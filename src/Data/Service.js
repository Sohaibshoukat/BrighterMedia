export const servicedata=[
    {
        head:"Creative",
        para:"We produce Creative for Organic and Paid Social distribution",
        Point:[
    ...
    {
        head:"Influencer",
        para:"We deliver brand awareness and direct-response Influencer & Creator campaigns",
        Point:[
    ...
    {
        head:"Paid",
        para:"We deliver performance-driven Paid Social and Paid Search campaigns",
        Point:[
    ...
    {
        head:"Social",
        para:"We grow cult-like social communities with platform-specific social strategies",
        Point:[
            " Social Strategy",
