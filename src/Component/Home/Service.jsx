    ...
    <div className="bg-[#f4f4f4] py-20">
      <div className="w-[90%] m-auto">
        <div className="flex flex-col gap-6 font-pop">
          <h1 className="max-w-[30%] text-left text-black font-bold text-5xl">
                ...
                <div className="flex flex-col font-pop gap-4 justify-between py-10 px-6 h-[100%]">
                  ...
                  <div className="flex flex-col gap-2">
                    {item?.Point.map((item2, index2) => (
                      ...
                      >
                        <img
                          src="https://thesocialshepherd.com/dist/images/tick.svg"
                          alt=""
                          className="w-[20px] "
                        />
                  ...
                  <a
                    href="/contact"
                    className="float-end bg-transparent border-2 border-black hover:bg-black text-black hover:text-white ease-in-out duration-300 py-2 text-center rounded-full"
                  >
                    {item.learn}
                  </a>
                </div>
